...
import json
import numpy as np
from TS_TMP import TSvec2onehot
...
v2o = TSvec2onehot.vec2onehot()  # create the one-bot dicts
...
def get_vec_from_features_TS(path):
    node = path + "ts_node_feature.txt"
    edge = path + "ts_edge_feature.txt"
