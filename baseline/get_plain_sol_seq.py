...
class FilePscAnalyzer:
    ...
    def do_change_to_sequence(self):
        ...
        # 4. 双引号变成单引号
        nowContent = changeApostrophe(nowContent)
    ...
    def save_sequence_content_to_file(self):
        with open("ttt.txt", "w+") as f:
            f.write(self.sequence_content)

    def get_content(self):
        return self.sequence_content
